...
A more sophisticated form of enslavement is not a step toward justice. It is merely an improvement within the very system that turns individuals into property. Perhaps that is why so many forms of care seem extraordinary: when injustice becomes normalized, even improvements within it can be mistaken for justice.